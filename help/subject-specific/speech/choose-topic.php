<?php
   $page_title = "Choosing a Topic - Benner Library";
	$body_class = "";
	$body_id = "";
	$css = "";
	$js = ""; 
...
?>
<!-- ===== content below here ========================================================== -->
<h2 class="header-line">Choosing a Topic: Background Sources</h2>
	<p>
		<iframe width="640" height="480" src="https://www.youtube.com/embed/QZF2bkjXNYM" frameborder="0" allowfullscreen></iframe>
	</p>
