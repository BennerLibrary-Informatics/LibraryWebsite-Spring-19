...
<head>
    ...
    <title>BDW Dynamic Example - Benner Library Online</title>
...
<div id='content_wrapper'>     	
  <div id='left_col'>
	<div class='offsetleft offsetright'>
		...
		<!-- InstanceBeginEditable name="left_nav" -->
            ...
            <h3>Related Links</h3>
			<a href="/bdw/bdw_request.php">BDW Request Form</a>
  ...
  <div id='center_col'>
	...
	Fixed width - This choice sets the width of each book cover.  It does not adjust height so the display may be taller depending on the size of each cover.  This will display the entire book wid but it will not necessarily be uniform from cover to cover.<br />
