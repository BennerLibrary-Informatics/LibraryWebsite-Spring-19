<?php
   $page_title = "Primary Sources: Humanities: Religion - Benner Library";
	$body_class = "";
	$body_id = "";
	$css = "";
	$js = "";
...
<div class="split l60-r40 cf">
   <div class="left">
		<h3 class="no-margin-top bold">Selected Religion Resources</h3>
			<ul class="link-list irs">
			<?php echo print_subject('38', array('5', '2', '3', '12'), 'base_convert', 'tutorial', 'gon', 'flo'); ?>
			</ul>
	...
	<br /><br />
		<h5 class="no-margin-top bold">More Selected Resources</h5>
		   	<ul class="link-list padding10-left">
				...
				<li><a id="pdf" href="/subject-guides/primary-sources/humanities/doc/print-books.pdf">Print Resources</a></li>
		    </ul>
	</div>
</div>
