<?php
   $page_title = "SSCI302 - Benner Library";
	$body_class = "";
	$body_id = "";
	$css = "";
	$js = "";
...
?>
<!-- ===== content below here ========================================================== -->
<h2 class="header-line">SSCI 302: World Regional Geography</h2>
<h3>Books</h3>
	<p>
  ...
  <h3>Country background</h3>
		<ul>
			<li><a href="https://www.state.gov/p/index.htm" target="_blank">Diplomacy in Action</a> from the US Department of State</li>
