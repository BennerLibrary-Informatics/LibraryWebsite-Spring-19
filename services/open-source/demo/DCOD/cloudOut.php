...
?>
<?php
//All this does is print off the TAGcloud in a more modular function. Kind of pointless.
include 'class/config.php';
include 'class/wordCloud.php';
echo wordCloud::tagCloud($db);
?>