...
$dbuser = "\t'user'=>'" . $_REQUEST['dbuser'] . "',\n";
$pass =   "\t'pass'=>'" . $_REQUEST['dbpass'] . "',\n";
$dbname = "\t'name'=>'" . $_REQUEST['dbname'] . "'\n";
$part2=$host.$dbuser.$pass.$dbname;

$dbFile=$part1.$part2.$part3;


$file=file_put_contents('config/local.php', $dbFile);
echo $file;
?>
