...
<?php    
    // Email headers
    $to_names    = isset($_REQUEST['to_names']) ? $_REQUEST['to_names'] : $_SESSION['dcod_sys_admin'];
    $to_emails   = isset($_REQUEST['to_emails']) ? $_REQUEST['to_emails'] : $_SESSION['dcod_sys_email'];
    $from_name  = $_SESSION['dcod_sys_short_name'];
    ...
    {
        $message.= "You have a ".$_SESSION['dcod_sys_short_name']." category suggestion.\n\n";
        $message.= "Category Suggestion:  ".$_REQUEST['category']."\n\n";
    }
    
    $message.= "Message:\n";
    $message.= $_REQUEST['message'];
    $from = "From: $from_email\r\n";
    mail($to_emails, $subject, $message, $from);
